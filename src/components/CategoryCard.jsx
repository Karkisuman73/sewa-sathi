...
const CategoryCard = ({ category }) => {
  ...
  return (
    <Link
      ...
      className="group block rounded-2xl border border-slate-200 bg-white p-6 transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg"
    >
